...
#cost of current car
#OC = original car
OCpay = raw_input('Are you still paying for the purchase of your car? (Y/N)')
if "y" in OCpay:
OCpay = int(raw_input('How much do you pay every month? (£) '))
elif "n" in OCpay:
OCpay = int(0)
print
OCpetrol = (int(raw_input('How much petrol does your current car use each week?: £'))*(float(4.33)))
print
...
OCrep = int(0)
print
OCtot = OCpay + OCpetrol + OCins + OCtax + OCmot + OCser + OCrep
